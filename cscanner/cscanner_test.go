...
func TestPortScanDetector1(t *testing.T) {
	perms := [][]string{
		...
		{"18:", "0F02000A:E97E", "59B871D8:01BB", "01 00000000:00000000 02:00000055 00000000  1000        0 43659 2 0000000000000000 24 4 26 10 -1"},
		{"19:", "0F02000A:01FB", "6221FB8E:E97E", "01 00000000:00000000 00:00000000 00000000  1000        0 46059 1 0000000000000000 21 4 13 10 -1"},
		{"20:", "0F02000A:0035", "6221FB8E:E2BC", "01 00000000:00000000 02:000001FF 00000000  1000        0 46155 2 0000000000000000 24 4 30 10 -1"},
		{"21:", "0F02000A:01BA", "6221FB8E:01BA", "01 00000000:00000000 00:00000000 00000000  1000        0 40952 1 0000000000000000 21 4 0 10 -1"},
		{"22:", "0F02000A:E2BC", "6DD9FA8E:01BB", "01 00000000:00000000 00:00000000 00000000  1000        0 45308 1 0000000000000000 21 4 1 10 -1"},
	}
	...
	for ips, expected_ports := range answers {
		if actual_ports, ok := port_scans[ips]; ok {
			...
			assert.Fail(t, "An expected result was not obtained", actual_ports, expected_ports)
		}
	}
